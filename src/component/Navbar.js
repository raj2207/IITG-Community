    ...
    return(
        <div className="qheader">
            ...
            <div className="qheader_rem">
                ...
                <LanguageIcon />
                <Button onClick={() => setOpenModal(true)}>Add Doubt</Button>
                <Modal
                 isOpen={openModal}
                    ...
                    <div className="modal_info">
                        ...
                        <div className="modal_field">
                            <Input 
                             ...
                             type="text"
                             placeholder="Start your doubt with 'What, 'How', 'Why' etc. "
                            />
                        ...
                        <button onClick={handleQuestion} type="submit" className="add">Add Doubt</button>
                        </div>
                </Modal>
            </div>
        </div>
